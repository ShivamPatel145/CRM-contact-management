...
import { registerSchema as clientRegisterSchema } from "../../validators/auth.validator";
        ...
        <div className="relative w-full max-w-[500px] h-[500px]">
           ...
           <div className="absolute bottom-12 left-8 w-80 h-72 rounded-3xl bg-background/90 border border-border shadow-2xl backdrop-blur-xl p-8 z-10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-foreground mb-3 leading-tight">Scale your <br/> business securely.</h3>
